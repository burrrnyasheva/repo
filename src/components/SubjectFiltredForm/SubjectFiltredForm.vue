<template>
  <div :class="$style.root">
    ...
    <div :class="$style.item">
      ...
      <input v-model="form.subject" :class="$style.input"  id="subject" placeholder="Название" type="text">
    </div>
    <div :class="$style.item">
      <div :class="$style.label">
    ...
    <div :class="$style.item">
      <div :class="$style.label">
        <label for="hours">Цена</label>
      </div>
      <input v-model="form.hours" :class="$style.input" id="hours" placeholder="Цена" type="number">
    </div>
    <div :class="$style.item">
      <div :class="$style.label">
  ...
  setup(props, context) {
    ...
    return {
      ...
      onClick: () => {
        ...
        router.push({ name: 'SubjectsFiltred' })
      }
    }
  },
}
