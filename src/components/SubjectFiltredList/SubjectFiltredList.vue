<template>
  <div :class="$style.root">
    <Table
      :headers="[
        {value: 'id', text: 'ID'},
        {value: 'subject', text: 'Название'},
        {value: 'description', text: 'Описание'},
        {value: 'hours', text: 'Цена'},
        {value: 'teacher', text: 'Автор'},
    ...
    <router-link :to="{ name: 'SubjectFiltredEdit' }">
...
import { selectItems, removeItem, fetchItems } from '@/store/subjectsfiltred/selectors';
import Table from '@/components/Table/Table';
import Btn from '@/components/Btn/Btn';

export default {
  name: 'SubjectFiltredList',
  components: {
    Table,
    Btn,
  },
  setup() {
    ...
    return {
      ...
      onClickEdit: id => {
        router.push({ name: 'SubjectFiltredEdit', params: { id } })
      }
    }
  }
